...
public class Portal : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        // Teleportation causes momentary flicker when exiting portal to being teleported, have tried fixing this
        // issue but no luck.
        HandleTravellers();
    }
    ...
    void HandleTravellers()
    {
        for (int i = 0; i < trackedTravellers.Count; i++)
        {
            ...
            {
                //Debug.Log("You have entered the portal");
    ...
    public void Render()
    {
        ...
        var newCameraPlace = transform.localToWorldMatrix
            * linkedPortal.transform.worldToLocalMatrix
            * playerCam.transform.localToWorldMatrix;
        portalCam.transform.SetPositionAndRotation(newCameraPlace.GetColumn(3), newCameraPlace.rotation);
        // handle near clipping for portal camera's
        SetNearClipPlane();
        // Render the Camera
        // ISSUE: Sometimes, an error occurs on this function called "Screen Position out of view frustrum", which causes
        // a crash. Not sure how to fix this
        portalCam.Render();
        // re-enable screen
        screen.enabled = true;
    }
    ...
    void ProtectScreenFromClipping()
    {
        ...
        // This value handles how farback the screen should be pushed inside the portal
...
//        screenT.localScale = new Vector3(screenT.localScale.x, screenT.localScale.y, screenThickness);
//        screenT.localPosition = Vector3.forward * screenThickness * ((camFacingSameDirAsPortal) ? 0.05f : -0.05f);
